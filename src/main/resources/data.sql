...
INSERT INTO `operation` (`user_id`, `buddy_id`, `date`, `type`, `amount`, `description`) VALUES ('2', '3', '2022-10-21', 'op', '10', 'Addition restaurant');
INSERT INTO `operation` (`user_id`, `buddy_id`, `date`, `type`, `amount`, `description`) VALUES ('2', '4', '2022-10-22', 'op', '10', 'Cinema');
INSERT INTO `operation` (`user_id`, `buddy_id`, `date`, `type`, `amount`, `description`) VALUES ('2', '5', '2022-10-23', 'op', '10', 'Parking');
INSERT INTO `operation` (`user_id`, `buddy_id`, `date`, `type`, `amount`, `description`) VALUES ('4', '2', '2022-10-21', 'op', '50', 'Week-end');
